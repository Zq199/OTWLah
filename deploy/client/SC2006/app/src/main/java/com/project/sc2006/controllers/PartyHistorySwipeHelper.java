...
public abstract class PartyHistorySwipeHelper extends ItemTouchHelper.SimpleCallback{
    int buttonWidth;
    ...
    public PartyHistorySwipeHelper(int dragDirs, int swipeDirs) {
        super(dragDirs, swipeDirs);
    }

    public PartyHistorySwipeHelper(Context context, RecyclerView recyclerView, int buttonWidth){
    ...
    public static class MyButton {
        ...
        public MyButton(Context context, String text, int textSize, int imageResId, int color, DeleteButtonClickListener listener){
            this.text = text;
    ...
    public void onChildDraw(@NonNull Canvas c, @NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            if(dX < 0){
                List<MyButton> buffer = new LinkedList<>();
